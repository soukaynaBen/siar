...
export default function Awards({awards:data}) {
 ...
 const CardComponent=({title,description,footer})=>(
  ...
  <div ref={ref2} className='sm:grid sm:grid-cols-2 md:flex justify-end md:flex-row gap-8 md:gap-0 flex flex-col items-center  md:w-fit md:py-16  py-10 md:mx-auto sm:px-2'>

   {data?.map((item,index)=>{ 
          return(<div  key={index} className="award" >
